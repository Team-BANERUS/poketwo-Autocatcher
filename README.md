...
:bangbang: | Pokétwo is currently undergoing a full rewrite—if you're looking to contribute, please be advised that I do not intend to make too many changes to the current version. Best bot to exist till now. These screenshot are of version 1.0.0 ; check the current version
:---: | :---
